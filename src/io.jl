...
function write_trajectory_xyz(filename, res::ODESolution, params; overwrite=false)
...
function write_trajectory_pvt(filename, res::ODESolution, params; overwrite=false)
